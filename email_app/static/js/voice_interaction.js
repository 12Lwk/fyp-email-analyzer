...
// Voice interaction module - disabled to prevent conflicts with hotword_detection.js
console.log('Voice interaction module disabled - using hotword_detection.js instead');

// Export empty functions to prevent errors if they're called
window.initSpeechRecognition = function() {
    console.log('Speech recognition handled by hotword_detection.js');
    return false;
};

window.startVoiceRecognition = function() {
    console.log('Voice recognition handled by hotword_detection.js');
    return false;
};
